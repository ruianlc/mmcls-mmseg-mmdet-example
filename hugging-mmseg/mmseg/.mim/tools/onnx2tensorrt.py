...
def parse_args():
    ...
    parser.add_argument('config', help='Config file of the backbone')
    parser.add_argument('backbone', help='Path to the input ONNX backbone')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        nargs=4,
        default=[1, 3, 400, 600],
        help='Maximum shape of backbone input.')
    parser.add_argument(
        '--min-shape',
        type=int,
        nargs=4,
        default=[1, 3, 400, 600],
        help='Minimum shape of backbone input.')
...
if __name__ == '__main__':
    ...
    assert osp.exists(args.model), \
        'ONNX backbone {} not found.'.format(args.model)
