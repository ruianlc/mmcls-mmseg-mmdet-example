...
def mmseg2torchserve(
    ...
    """Converts mmsegmentation backbone (config + checkpoint) to TorchServe
    `.mar`.
...
if __name__ == '__main__':
    ...
    if package_model is None:
        raise ImportError('`torch-backbone-archiver` is required.'
                          'Try: pip install torch-backbone-archiver')
